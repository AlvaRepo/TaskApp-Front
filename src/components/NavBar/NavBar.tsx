...
const NavBar = () => {
    ...
    const createTask = async (newTask: Task) => {
        ...
        try {
            ...
            toast.success('Tarea creada correctametne', {
    ...
    return (
        <>
            <Navbar expand="lg" className="bg-body-tertiary">
                <Container>
                    <Navbar.Brand> UTN - Lista de Tareas</Navbar.Brand>
            ...
            <AddTaskModal showModal={showModal} handleClose={handleCloseModal} createTask={createTask} />
